...
headers = {
	...
	"Referer": "https://192.168.3.43/register",
...
while True:
    ...
    r = requests.post("https://192.168.3.43/backend-api/api/auth/register",headers = headers, data=data, verify=False)
    print(f"{i} {r}")
    time.sleep(7)
